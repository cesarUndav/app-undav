...
async function obtenerLinksYLabelsDelPrimerParrafo(): Promise<
...
export default function Calendario() {
  ...
  const [linksWebCal, setLinksWebCal] = useState<
    { href: string; label: string }[]
  >([]);
          ...
          {linksWebCal.length > 0 && (
            <>
              <CustomText weight="bold" style={styles.title}>
                Resoluciones más recientes del Calendario Académico en formato
                PDF:
              </CustomText>
