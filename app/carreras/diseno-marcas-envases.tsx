...
export default function DisenoMarcasEnvases() {
  ...
  const pdfs: { [key: string]: any } = {
    'diseno-marcas-envases-plan-estudios.pdf': require('../../assets/docs/diseno-marcas-envases-plan-estudios.pdf'),
    'diseno-marcas-envases-plan-creditos.pdf': require('../../assets/docs/diseno-marcas-envases-plan-creditos.pdf'),
    'diseno-marcas-envases-postal-digital.pdf': require('../../assets/docs/diseno-marcas-envases-postal-digital.pdf'),
  };
  ...
  const secciones = [
    {
      ...
      contenido: (
        <CustomText style={styles.oracion}>
          Técnico/a en Diseño de Marcas y Envases
        </CustomText>
      ),
    },
    {
