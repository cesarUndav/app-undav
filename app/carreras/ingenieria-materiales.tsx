// app/carreras/ingenieria-materiales.tsx
...
export default function IngenieriaMateriales() {
  ...
  const secciones = [
    ...
    },
    {
      ...
      contenido: (
        <CustomText style={styles.oracion}>
          Preparar profesionales para el diseño, selección, procesamiento,
          control de calidad y desarrollo de materiales para diversas
          industrias, promoviendo investigación e innovación.
        </CustomText>
      ),
    },
    {
      ...
      contenido: (
        <CustomText style={styles.oracion}>
          Formación sólida en matemáticas y química de materiales, con una visión
          orgánica y flexible del comportamiento de sustancias desde materias
    ...
    },
    {
      ...
      contenido: (
        <CustomText style={styles.oracion}>
          Capaz de diseñar, desarrollar, fabricar y reciclar materiales,
          resolver problemas de ingeniería de materiales y actuar con
    ...
    },
    {
      ...
      contenido: (
        <View>
          <TouchableOpacity
            onPress={() => handleOpenPDF('ingenieria-materiales-plan-estudios.pdf')}
          >
          ...
          <TouchableOpacity
            onPress={() => handleOpenPDF('ingenieria-materiales-postal-digital.pdf')}
          >
            <CustomText weight="bold" style={styles.link}>
    ...
    },
    {
      ...
      contenido: (
        <View>
          ...
          <CustomText style={styles.oracion}>
            Director: Mg. Silvio Colombo
          </CustomText>

          <TouchableOpacity
            onPress={() => Linking.openURL('mailto:ingmateriales@undav.edu.ar')}
          >
            <CustomText weight="bold" style={[styles.oracion, styles.link]}>
              Contacto: ingmateriales@undav.edu.ar
            </CustomText>
          </TouchableOpacity>
        </View>
      ),
