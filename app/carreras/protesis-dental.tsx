// app/carreras/protesis-dental.tsx
...
export default function ProtesisDental() {
  ...
  const secciones = [
    ...
    },
    {
      ...
      contenido: (
        <CustomText style={styles.oracion}>
          La Tecnicatura en Prótesis Dental ofrece formación integrada en
          ciencia y tecnología para la correcta construcción de prótesis
          dentales, con sólidas bases teórico-prácticas y énfasis en habilidad
          manual.
        </CustomText>
      ),
    },
    {
      ...
      contenido: (
        <CustomText style={styles.oracion}>
          Formar profesionales capaces de confeccionar diversos tipos de
          prótesis dentales y asistir en la rehabilitación de la salud oral en
          colaboración con odontólogos.
        </CustomText>
      ),
    },
    {
      ...
      contenido: (
        <CustomText style={styles.oracion}>
          Egresado con sólida formación para diseñar y elaborar aparatos
          protéticos dentales, participando en equipos de salud y adaptando
          técnicas a casos clínicos específicos.
        </CustomText>
      ),
    },
    {
      ...
      contenido: (
        <View>
          <TouchableOpacity
            onPress={() => handleOpenPDF('protesis-dental-plan-estudios.pdf')}
          >
          ...
          <TouchableOpacity
            onPress={() => handleOpenPDF('protesis-dental-postal-digital.pdf')}
          >
            <CustomText weight="bold" style={styles.link}>
    ...
    },
    {
      ...
      contenido: (
        <View>
          ...
          <CustomText style={styles.oracion}>
            Coordinadora: Téc. Silvia Cáceres
          </CustomText>
          ...
          <TouchableOpacity
            onPress={() => Linking.openURL('mailto:saludprotesis@undav.edu.ar')}
          >
            <CustomText weight="bold" style={[styles.oracion, styles.link]}>
              Consultas de la carrera: saludprotesis@undav.edu.ar
            </CustomText>
          </TouchableOpacity>
        </View>
      ),
