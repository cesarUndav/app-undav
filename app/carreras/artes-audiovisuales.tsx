// app/carreras/artes-audiovisuales.tsx
...
export default function ArtesAudiovisuales() {
  ...
  const secciones = [
    ...
    },
    {
      ...
      contenido: (
        <CustomText style={styles.oracion}>
          La carrera forma profesionales en artes audiovisuales, integrando base
          artística visual y realización audiovisual, apoyados en nuevas
          tecnologías y normativas vigentes.
        </CustomText>
      ),
    },
    {
      ...
      contenido: (
        <CustomText style={styles.oracion}>
          Formar profesionales con sólida formación para diseñar, producir y
          gestionar proyectos visuales y audiovisuales de calidad, incorporando
    ...
    },
    {
      ...
      contenido: (
        <View>
          <TouchableOpacity
            onPress={() =>
              handleOpenPDF('artes-audiovisuales-plan-creditos.pdf')
            }
          >
            <CustomText weight="bold" style={styles.link}>
              • Descargar Plan de crédito (Res. CS 281/2016)
            </CustomText>
          </TouchableOpacity>

          <TouchableOpacity
            onPress={() =>
              handleOpenPDF('artes-audiovisuales-postal-digital.pdf')
            }
          >
            <CustomText weight="bold" style={styles.link}>
