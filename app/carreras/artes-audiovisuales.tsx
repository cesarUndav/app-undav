...
export default function ArtesAudiovisuales() {
  ...
  const pdfs: { [key: string]: any } = {
    'artes-audiovisuales-plan-creditos.pdf': require('../../assets/docs/artes-audiovisuales-plan-creditos.pdf'),
    'artes-audiovisuales-postal-digital.pdf': require('../../assets/docs/artes-audiovisuales-postal-digital.pdf'),
  };
  ...
  const secciones = [
    ...
    },
    {
      ...
      contenido: (
        <CustomText style={styles.oracion}>
          La carrera forma profesionales en artes audiovisuales, integrando base artística visual y realización audiovisual, apoyados en nuevas tecnologías y normativas vigentes.
        </CustomText>
      ),
    },
    {
      ...
      contenido: (
        <CustomText style={styles.oracion}>
          Formar profesionales con sólida formación para diseñar, producir y gestionar proyectos visuales y audiovisuales de calidad, incorporando avances tecnológicos y éticos.
        </CustomText>
      ),
    },
    {
      ...
      contenido: (
        <View>
          <TouchableOpacity onPress={() => handleOpenPDF('artes-audiovisuales-plan-creditos.pdf')}>
            <CustomText style={styles.link}>• Descargar Plan de crédito (Res. CS 281/2016)</CustomText>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleOpenPDF('artes-audiovisuales-postal-digital.pdf')}>
    ...
    },
    {
      ...
      contenido: (
        <View>
          ...
          <CustomText style={styles.oracion}>Director: Pablo Rovito</CustomText>
