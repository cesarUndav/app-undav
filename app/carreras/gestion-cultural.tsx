  ...
  const secciones = [
    {
      ...
      contenido: (
        <View>
          <CustomText style={styles.oracion}>• Técnico/a Universitario/a en Gestión Cultural</CustomText>
          <CustomText style={styles.oracion}>• Licenciado/a en Gestión Cultural</CustomText>
        </View>
      ),
    },
    {
      ...
      contenido: (
        <CustomText style={styles.oracion}>
          Capacita al profesional productor y gestor de la cultura en producción, gestión y administración de servicios culturales, análisis e interpretación de recursos culturales.
        </CustomText>
      ),
    },
    {
      ...
      contenido: (
        <CustomText style={styles.oracion}>
          Formar profesionales capaces de concebir, diseñar, gestionar y ejecutar políticas y proyectos culturales, asesorar en protección del patrimonio y promover identidades locales.
        </CustomText>
      ),
    },
    {
      ...
      contenido: (
        <View>
          <TouchableOpacity onPress={() => handleOpenPDF('gestion-cultural-plan-estudios.pdf')}>
            <CustomText style={styles.link}>• Descargar Plan de estudio (*)</CustomText>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleOpenPDF('gestion-cultural-plan-creditos.pdf')}>
            <CustomText style={styles.link}>• Descargar Plan de crédito (Res. CS 124/2015)</CustomText>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleOpenPDF('gestion-cultural-postal-digital.pdf')}>
    ...
    },
    {
      ...
      contenido: (
        <View>
          ...
          <CustomText style={styles.oracion}>Directora: Lic. Úrsula Rucker</CustomText>
