...
export default function Economia() {
  ...
  const secciones = [
    ...
    },
    {
      ...
      contenido: (
        <CustomText style={styles.oracion}>
          La carrera de Economía ofrece reflexión crítica sobre entornos económicos y sociales, entendiendo la economía como ciencia social dinámica con protagonismo estatal y pluralidad de enfoques teóricos.
        </CustomText>
      ),
    },
    {
      ...
      contenido: (
        <CustomText style={styles.oracion}>
          Formar economistas capaces de desempeñarse en ámbitos públicos y privados, con enfoque en el rol de las instituciones estatales en el desarrollo económico y social.
        </CustomText>
      ),
    },
    {
      ...
      contenido: (
        <View>
          <TouchableOpacity onPress={() => handleOpenPDF('economia-plan-estudios.pdf')}>
            <CustomText style={styles.link}>• Descargar Plan de estudio</CustomText>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleOpenPDF('economia-plan-creditos.pdf')}>
            <CustomText style={styles.link}>• Descargar Plan de crédito (Res. CS 198/2015)</CustomText>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleOpenPDF('economia-postal-digital.pdf')}>
